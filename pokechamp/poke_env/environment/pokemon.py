...
class Pokemon:
    ...
    def __init__(
        ...
        *,
        ...
        # Load appropriate sets file based on battle format using shared cache
        ...
        if sets_file not in self._SETS_CACHE:
            with open(sets_file, 'r') as f:
                self._SETS_CACHE[sets_file] = json.load(f)
        
        self._sets = self._SETS_CACHE[sets_file]
    ...
    def type_1(self) -> PokemonType:
        ...
        :rtype: PokemonType
        """
        if self._terastallized and self._terastallized_type is not None and self._terastallized_type != PokemonType.STELLAR:
    ...
    def type_2(self) -> Optional[PokemonType]:
        ...
        """
        if self._terastallized and self._terastallized_type != PokemonType.STELLAR:
            return None
        return self._type_2
