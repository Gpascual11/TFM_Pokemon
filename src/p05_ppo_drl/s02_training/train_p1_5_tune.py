"""Phase 1.5: Training against MaxBasePower Opponents.

Resumes training from Phase 1 to teach the model defensive switching
and type advantages using MaxBasePowerPlayer as a stepping stone.
"""
...
def main():
    ...
    print("--- Starting Phase 1.5 Training (Curriculum: MaxBasePower) ---")
