...
- **Command:** `uv run python src/p02_imitation_learning/s02_eda/eda_pokemon_battles.py`
...
- **Commands:**
  ...
  2. `uv run python src/p02_imitation_learning/s03_training/train_ml_baseline.py`
