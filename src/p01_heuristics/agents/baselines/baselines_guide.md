# Heuristics Baselines Guide: Technical Rationale for Custom Baselines

In the heuristics framework, we use specialized versions of certain baseline players. This document explains why these custom implementations exist and what problems they solve.
