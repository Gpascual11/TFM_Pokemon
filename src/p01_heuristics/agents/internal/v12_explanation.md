...
Heuristic V12 adds Gen 9 Terastallization and matchup-based fainted switch-in. It subclasses `BaseHeuristic1v1`. On the gen9 10k gauntlet it is the bot-vs-bot ceiling (~59.9% vs Abyssal). The 28-agent gen9 matrix is the paradigm study; cross-generation Elo tables use smaller agent sets.
...
### A. Matchup-Based Fainted Switch-in Selection
...
### B. Priority KO Pre-Check Hook (`_pre_move_hook`)
...
### C. Weather and Terrain Modifiers
...
### D. Defensive Switching & V3 Defensive Pivot (`_should_switch`)
...
### E. Low-HP Sack Logic (`SAC_HP_THRESHOLD = 0.2`)
...
### F. Pivot Moves (Volt Switch / U-turn)
...
### G. Tight Hazards & Setup on Free Turns
...
### I. Gen 9 Terastallization Logic
