...
|--------|-------------------|------------------------|-------------|
| **Internal Heuristics** | `v1`–`v13` | `agents/internal/` (`HeuristicV1`–`HeuristicV13`) | Main research agents; all inherit from `BaseHeuristic1v1` and use shared math in `p00_core/core/common.py`. |
