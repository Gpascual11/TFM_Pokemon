...
import sys
# The current file is in src/p03_ml_baseline/s02_eda/gen9random/eda_pokemon_battles.py
...
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "src/p03_ml_baseline/s02_eda/plots/gen9random")
