...
DATA_DIR = Path(__file__).resolve().parents[4] / "data" / "benchmarks" / "all_10k"
REPORT_DIR = Path(__file__).resolve().parents[4] / "report"

# Historical 18-agent order (v1–v12 + baselines). The gen9 paradigm matrix is 28 agents
# (v1–v22 + 6 baselines). Do not use this script as the thesis ranking of v13–v22.
AGENT_ORDER = [
