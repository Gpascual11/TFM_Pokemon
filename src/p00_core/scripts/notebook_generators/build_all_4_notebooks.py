...
reporting_dir = str(Path(__file__).resolve().parents[4] / "src/p00_core/reporting")
...
build_notebook('src/p00_core/reporting/eda_mcts_v18_v20.ipynb', 
               ...
               'EDA for shallow root-UCB MCTS (LocalSim rollouts). Not IS-MCTS.', 
