...
OUT = Path(__file__).resolve().parents[4] / "src/p00_core/reporting/eda_heuristics_v1_v14.ipynb"
...
| Jump 3 | **v12** | Tera + fainted switch-in (no Team Preview on this format) | **69.0%** |
...
**v18–v20 shallow MCTS** · v21 IL hybrid · v22 IL (synthetic moves). Executive reports under `agents/v1/` …
...
WHAT_ADDED = {
    ...
    "v7": "boost-aware damage + matchup switch",
    ...
    "v12": "Tera + fainted switch-in (no preview on this format)",
    "v13": "recovery / choice-lock; sets DB not loaded",
    "v14": "Yomi, T1–3 scouting, approx. damage, 1-ply endgame",
}
...
REGIME = {
    **{f"v{i}": "Plateau" for i in range(1, 7)},
    ...
    "v12": "Tera / fainted switch",
    "v13": "Revealed-move matchups",
    "v14": "Yomi / scouting",
}
REGIME_COLOR = {
    "Plateau": "#8AA2B8",
...
lines = [
    ...
    "## Taxonomy",
    "",
    "v1–v14 heuristic · v15–v17 1-ply minimax · v18–v20 shallow MCTS · v21 IL hybrid · v22 IL (synthetic moves).",
