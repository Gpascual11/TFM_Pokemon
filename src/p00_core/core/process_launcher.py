...
def _worker(
    ...
    # We need 'src' in sys.path so we can import as 'p00_core.core...'
    _this_dir = os.path.dirname(os.path.abspath(__file__))  # core
    _p00_dir = os.path.dirname(_this_dir)  # p00_core
    _src_dir = os.path.dirname(_p00_dir)  # src
...
class ProcessLauncher:
    ...
    def __init__(
        ...
        data_dir: str | Path = "data/testing/runs",
        opponent: str = "random",
    ) -> None:
