...
Usage::
    ...
    uv run python src/p00_core/engine/run_single.py v6 random 100

    # 1 000 games, 4 parallel ports
    uv run python src/p00_core/engine/run_single.py v5 max_power 1000 -p 8000 8001 8002 8003
"""
...
# File lives at: src/p00_core/engine/run_single.py
# ---------------------------------------------------------------------------
_THIS_DIR = os.path.dirname(os.path.abspath(__file__))
_EVAL_DIR = os.path.dirname(_THIS_DIR)  # p00_core/
_SRC_DIR = os.path.dirname(_EVAL_DIR)   # src/

if _SRC_DIR not in sys.path:
    sys.path.insert(0, _SRC_DIR)

__package__ = "p00_core.engine"


from p00_core.core.battle_manager import BattleManager
from p00_core.core.factory import HeuristicFactory
from p00_core.core.process_launcher import ProcessLauncher
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--data-dir",
        type=str,
        default="data/testing/runs",
        help="Output directory for per-battle CSVs (default: data/testing/runs).",
    )
    parser.add_argument(
        "--log-level",
        type=str,
