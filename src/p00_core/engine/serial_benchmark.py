...
Usage::
    ...
    uv run python src/p00_core/engine/serial_benchmark.py 1000 -p 4 --resume
"""
...
# Package bootstrap
# ---------------------------------------------------------------------------
# This file lives at: src/p00_core/engine/serial_benchmark.py
...
def main() -> None:
    ...
    parser.add_argument(
        "--data-dir",
        type=str,
        default="data/testing/serial_v2",
        help="Directory for per-matchup battle CSVs.",
    )
    parser.add_argument(
        "--output-csv",
        type=str,
        default="src/p00_core/results/benchmark_summary.csv",
