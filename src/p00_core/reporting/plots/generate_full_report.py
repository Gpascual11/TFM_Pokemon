...
from p00_core.reporting.plots.styling import (
    BLUES_PREMIUM,
    COLORS,
    RD_YL_GN_PREMIUM,
    apply_premium_style,
...
DEFAULT_DATA_DIR = Path("data/benchmarks/all_10k")
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default=None, help="Directory to save the PNG reports. Defaults to --data-dir.")
