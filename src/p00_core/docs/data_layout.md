# Data Layout: `data/testing/`

This module standardizes all Singles (1v1) outputs under `data/testing/`. The structure is designed to keep raw data and analysis results co-located for better portability and organization.
...
All reporting scripts in `p00_core/reporting/` are now "data-aware." They will:
