...
EXPECTED_COLUMNS = [
    ...
    "search_switches_us", "search_switches_opp",
    "search_moves_us", "search_moves_opp",
    "endgame_solves_us", "endgame_solves_opp",
    "search_diff_us", "search_diff_opp",
    "total_turns_us", "total_turns_opp",
    "fainted_us", "remaining_pokemon_us", "total_hp_us", "hp_perc_us", "team_us", "side_conditions_us",
    "fainted_opp", "remaining_pokemon_opp", "total_hp_opp", "hp_perc_opp", "team_opp", "side_conditions_opp",
