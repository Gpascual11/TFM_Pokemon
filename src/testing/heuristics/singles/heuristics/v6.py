        ...
        if battle.available_moves:
            for move in battle.available_moves:
                ...
                if battle.weather:
                    ...
                    if "SUN" in w_name:
                        if move.type.name == "FIRE": score *= 1.5
                        elif move.type.name == "WATER": score *= 0.5
                    elif "RAIN" in w_name:
                        if move.type.name == "WATER": score *= 1.5
                        elif move.type.name == "FIRE": score *= 0.5
                        
                # Apply Terrain
                if battle.fields:
                    t_boosts = {"ELECTRIC": "ELECTRIC", "GRASSY": "GRASS", "PSYCHIC": "PSYCHIC"}
