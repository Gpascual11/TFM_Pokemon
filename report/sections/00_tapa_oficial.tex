...
\begin{center}
    % --- Official Logo ---
    \vspace*{-1cm}
    \includegraphics[width=8cm]{LA_SALLE-1000x340.jpg}\\[1.2cm]
    ...
    % --- Title Box ---
    \begin{tikzpicture}
        \node[draw=black, line width=0.8pt, rounded corners=2pt, inner sep=15pt, text width=0.92\textwidth, align=center] {
            \vspace{0.2cm}
            {\fontsize{14pt}{19pt}\selectfont\bfseries Desenvolupament d'agents experts per a la presa de decisions en entorns estocàstics i d'informació imperfecta: El cas de Pokémon\par}
            \vspace{0.35cm}
            {\fontsize{11pt}{15pt}\selectfont\itshape Avaluació empírica comparativa d'heurístiques, cerca adversària, MCTS, imitació i aprenentatge per reforç profund\par}
            \vspace{0.2cm}
        };
    \end{tikzpicture}
...
\textbf{Desenvolupament d'agents experts per a la presa de decisions en entorns estocàstics i d'informació imperfecta: El cas de Pokémon}\\[2.5ex]
