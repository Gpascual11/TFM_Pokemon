...
\begin{center}
    % --- Official Logo ---
    \vspace*{-1.2cm}
    \includegraphics[width=6cm]{logos/salle_ca.pdf}\\[0.7cm]
    
    % --- Faculty and Degree ---
    {\large \textbf{Facultat Internacional de Comerç i Economia Digital La Salle}}\\[0.35cm]
    {\Large \textbf{Treball de Final de Màster}}\\[0.25cm]
    {\large Màster Universitari en Ciència de les Dades / Data Science}\\[1.2cm]
    ...
    \begin{tabularx}{\textwidth}{@{}X r@{}}
        ...
        Gerard Pascual Fontanilles & Laura Serra Roig
    \end{tabularx}\\[1.5cm]
    
    % --- Date & Location ---
    {\small Barcelona, Setembre 2026}
\end{center}
\end{titlepage}
