...
El patró de dents de serra reflecteix el mecanisme de \texttt{--restart-every}: cada $N$ matchups completats, l'orquestrador mata i reenlaira els servidors Showdown, alliberant tots els processos \texttt{room-battle.js} acumulats. Combinat amb l'aïllament per subprocessos (cada batch de batalles en un procés Python independent), aquest sistema permet executar desenes de milers de batalles sense excedir els límits de memòria de la màquina.
