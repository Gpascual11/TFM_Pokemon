...
L'agent heurístic final (\textbf{v5 Apex} a Dobles i \textbf{v12} a Singles) s'ha consolidat com un baseline de referència molt fort, superant tots els baselines natius de la llibreria \textit{poke-env} i competint fre a fre amb agents d'estat de l'art com els de \textit{Pokechamp}.
