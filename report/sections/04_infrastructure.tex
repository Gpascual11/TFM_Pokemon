...
\end{itemize}
Aquesta base de codi suma \textbf{47.080 línies} (24.635 de Python, 14.896 de quaderns, 2.563 d'scripts i 4.986 de documentació). Les mètriques documenten l'abast del programari; no substitueixen l'avaluació empírica del Capítol~\ref{chap:resultats}.
...
El còmput d'hores reflecteix les 27 setmanes de calendari compreses entre el 14 de febrer i el 25 d'agost de 2026 (\textbf{113 commits} i \textbf{49 dies actius} acreditats a Git, Secció~\ref{sec:git_metrics}). L'esforç s'imputa directament a les fases de treball ja detallades en els capítols anteriors:
\begin{itemize}
...
\begin{enumerate}
    \item \textbf{Amortització del maquinari (188,50~€):} Tant el portàtil inicial com l'estació de treball són equips de propietat personal preexistents del desenvolupador. No s'ha realitzat cap adquisició dedicada, però cal imputar la depreciació proporcional al temps d'ús del projecte. L'estació de treball (valor estimat de 1.500~€, vida útil de 5 anys) i el portàtil (valor estimat de 1.200~€, vida útil de 5 anys) s'amortitzen linealment. Considerant el calendari d'ús efectiu del projecte (febrer--agost 2026), la fracció imputable és:
          \begin{itemize}
              \item Estació de treball (6,5 mesos d'experimentació continuada): $1.500 \times \frac{6{,}5}{60} = 162{,}50$~€.
              \item Portàtil (ús parcial inicial de posada en marxa, $1{,}3$ mesos): $1.200 \times \frac{1{,}3}{60} = 26{,}00$~€.
              \item Total amortització imputada: $162{,}50 + 26{,}00 = \mathbf{188{,}50}$~€.
          \end{itemize}
    \item \textbf{Temps d'execució i consum energètic ($\approx 5,85$~€):} L'estació de treball va funcionar de manera continuada 24/7 durant 28,5 dies, acumulant \textbf{685,04 hores de còmput continu de màquina} (471,38~h per a la matriu final Gen 9 i 213,66~h per a la resta de dades) sobre més de \textbf{52,7 milions de batalles}:
          \begin{itemize}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{lX r}
        ...
        \midrule
        Amortització maquinari      & Depreciació lineal proporcional (estació 1.500~€ + portàtil 1.200~€, 5 anys) & 188,50                 \\
        Consum energètic 24/7       & 685,04~h efectives (471,38~h Gen 9 + 213,66~h resta; 0,126561~€/kWh) & 5,85                      \\
        ...
        \midrule
        \textbf{Cost Directe Material} &                                                                   & \textbf{194,35}           \\
        \bottomrule
    \end{tabularx}
\end{table}
