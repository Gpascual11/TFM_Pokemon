...
Tal com reflecteix la Taula~\ref{tab:heur_h2h}, les dues orientacions de \texttt{v12} i \texttt{v13} difereixen només en 1,8~pp (50,65\% i 48,85\%) i no aporten una separació concloent. En canvi, \texttt{v14} queda clarament per sota de tots dos en els enfrontaments directes (44,74\% davant \texttt{v12} i 41,60\% davant \texttt{v13}).
...
\begin{enumerate}
    ...
    \item \textbf{Absència de restriccions tàctiques.} \texttt{v21} preserva els debilitaments garantits abans de consultar el model; \texttt{v22} no. La freqüència de Teracristal·lització de \texttt{v22} és alta (gairebé una vegada per partida, enfront de 0 a \texttt{v21}), però la freqüència per si sola no informa de la qualitat del moment triat.
\end{enumerate}
