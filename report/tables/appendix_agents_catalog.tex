...
\midrule
\texttt{random} & \texttt{RandomPlayer} & Trie uniforme entre totes les accions legals. Control inferior agnòstic. & $<0{,}1$~ms \\
...
\arrayrulecolor{gray!30}\hline\arrayrulecolor{black}
\texttt{PokéChamp} & \texttt{LLMPlayer} & Inferència LLM Ollama (Qwen 3 8B / Qwen 2.5 7B) amb serialització d'estat i CoT. & Explor. & $\sim 3$--$8$~s \\
\bottomrule
\end{tabularx}
\end{table}
