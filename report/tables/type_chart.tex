...
\begin{table}[htbp]
    \centering
    \caption[Matriu d'efectivitat de tipus]{Matriu d'efectivitat elemental en combat. Les files representen el tipus de l'atac executat i les columnes, el tipus del Pokémon defensor.}
