...
% Requereix: \usepackage{xcolor}, \usepackage{booktabs}, \usepackage{textcomp}
...
% Comandes per cel·les d'efectivitat (colorbox evita colortbl, incompatible amb booktabs)
\newcommand{\SE}{\colorbox{green!40}{\strut\textbf{2}}}
\newcommand{\NV}{\colorbox{red!20}{\strut\textonehalf}}
\newcommand{\IM}{\colorbox{gray!70}{\strut\textcolor{white}{\textbf{0}}}}
\newcommand{\NE}{}

% Comanda per capçaleres de tipus amb color
\newcommand{\ty}[2]{\colorbox{#1}{\strut\textcolor{white}{\textbf{#2}}}}

\begin{table}[H]
\centering
\caption{Matriu de tipus (generacions VI--IX). Les files representen el tipus de l'atac i les columnes, el tipus del defensor. \colorbox{green!40}{\scriptsize\textbf{2}} = supereficaç ($\times 2$), \colorbox{red!20}{\scriptsize\textonehalf} = poc eficaç ($\times 0{,}5$), \colorbox{gray!70}{\scriptsize\textcolor{white}{\textbf{0}}} = immunitat, buit = efectivitat neutra.}
