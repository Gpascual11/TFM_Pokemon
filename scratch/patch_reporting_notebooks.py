...
ROOT = Path(__file__).resolve().parents[1] / "src/p00_core/reporting"
...
| IS-MCTS v18–v20 | `eda_mcts_v18_v20.ipynb` |
...
new_agents = '''# Taxonomy: v1–v14 heuristic, v15–v17 1-ply minimax, v18–v20 IS-MCTS (n=1k),
