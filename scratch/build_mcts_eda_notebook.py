#!/usr/bin/env python3
"""Rebuild eda_mcts_v18_v20.ipynb as a three-agent lookahead / IS-MCTS comparison."""
from pathlib import Path

import nbformat as nbf

OUT = Path(__file__).resolve().parents[1] / "src/p00_core/reporting/eda_mcts_v18_v20.ipynb"
